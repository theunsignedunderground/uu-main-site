  ...
  async function go(plan) {
    try {
      ...
      if (data?.url) {
        ...
        alert(data?.error?.message || "Checkout error");
      }
    } catch (e) {
      console.error(e);
      ...
      <section style={section}>
        <div style={container}>
          ...
          <p style={compareText}>
            ...
            <br />
            Or, if you don’t need a website, choose <strong>Underground Fast Track</strong> for professional PR, playlist placement, and dashboard tools without the Showcase Site.
          </p>
          ...
          <div style={cards}>
            ...
            <div style={{ ...card, ...cardHighlight }}>
              ...
              <button style={primaryBtn} onClick={() => go("annual")}>Launch My Site – Best Value</button>
            </div>
            ...
            <div style={card}>
              ...
              <button style={secondaryBtn} onClick={() => go("monthly")}>Start Monthly Access</button>
              <p style={finePrint}>12-month minimum commitment required. Total $479.40 for first year.</p>
            </div>

            {/* Underground Fast Track (PR + Playlists, no site) */}
            <div style={card}>
              <h2 style={planTitle}>Underground Fast Track</h2>
              ...
              <button style={neutralBtn} onClick={() => go("fast_track")}>Get Underground Fast Track</button>
            </div>
          </div>
        </div>
      </section>
