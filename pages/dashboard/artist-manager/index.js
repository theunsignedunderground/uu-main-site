      ...
      <main>
        ...
        <section id="growth-system" className="block">
          <div className="container">
            <h2>Growth System</h2>
            <p>
              Build a weekly cadence that compounds: one flagship piece, three
              cut-downs, and daily micro-touches. Anchor everything to a clear
              narrative (who you are, who you’re for, why now).
            </p>
            <ul className="list">
              <li><strong>Weekly cadence:</strong> 1 longform (video or blog) → 3 cutdowns → daily clips/stories.</li>
              <li><strong>Audience loop:</strong> capture (content) → connect (DMs/email) → convert (tickets/merch).</li>
              <li><strong>Community:</strong> name your fans; reward top 1% with early listens and roles.</li>
            </ul>
          </div>
        </section>
        ...
        <section id="release-timeline" className="block">
          <div className="container">
            ...
            <ol className="steps">
              <li><strong>T-6w:</strong> assets locked (mix/master, cover, canvas, credits/metadata).</li>
              <li><strong>T-5w:</strong> distributor upload, pre-save live, press list draft, teaser 1.</li>
              <li><strong>T-4w:</strong> EPK page, teaser 2, pitch blogs/curators, UGC seed clips.</li>
              ...
              <li><strong>Launch week:</strong> premiere, pinned links, live AMA, fan reposts, thank-yous.</li>
              <li><strong>Post:</strong> acoustic/alt mix, lyric vid, remix call, showcase reel.</li>
            </ol>
          </div>
        </section>
        ...
        <section id="pr-outreach" className="block">
          <div className="container">
            <h2>PR & Outreach</h2>
            <p>
              Target niche outlets first; send short, skimmable pitches with a
              one-pager EPK and a story hook (why this track matters now).
            </p>
            <ul className="list">
              <li><strong>One-pager EPK:</strong> logline, 3-line bio, RIYL, best links, press photo.</li>
              <li><strong>Pitches:</strong> 5–7 sentences, one CTA, private link + download, no attachments.</li>
              <li><strong>Follow-ups:</strong> 4–5 days later; add a new angle (premiere date, feature, tour tie-in).</li>
            </ul>
          </div>
        </section>
        ...
        <section id="distribution-royalties" className="block">
          <div className="container">
            ...
            <ul className="list">
              <li><strong>Metadata:</strong> ISRC/ISWC, writers, splits, contributors, lyricist, producer, featured.</li>
              <li><strong>PRO/MLC:</strong> register works for performance + mechanicals; verify match after release.</li>
              <li><strong>Splits:</strong> agree in writing (split sheet) before release; store in your drive.</li>
            </ul>
          </div>
        </section>
        ...
        <section id="legal" className="block">
          <div className="container">
            ...
            <ul className="list">
              ...
              <li><strong>Licensing:</strong> keep stems ready; maintain a cue sheet template for easy sync pitches.</li>
            </ul>
          </div>
        </section>
          ...
          <div className="container">
            ...
            <div className="cards">
              ...
              <a className="card" href="/downloads/press-outreach.docx" target="_blank" rel="noreferrer">
                ...
                <p>Short, skimmable, with a clear story hook.</p>
              </a>
